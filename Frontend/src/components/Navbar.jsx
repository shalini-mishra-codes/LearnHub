...
//                   <input
//                     type="text"
//                     className="grow outline-none rounded-md px-1 dark:bg-slate-900 dark:text-white w-40"
//                     placeholder="Search"
//                     value={searchTerm}
//                     onChange={(e) => setSearchTerm(e.target.value)}
//                   />
...
//                 </svg>
//                 {wishlistItems.length > 0 && (
//                   <span className="badge badge-sm indicator-item bg-pink-500 text-white border-none">
//                     {wishlistItems.length}
//                   </span>
//                 )}
//               </div>
        ...
        <div className="navbar">
          ...
          <div className="navbar-end">
            <div className="flex items-center gap-1">
              ...
              <div className="hidden md:block">
                <form onSubmit={handleSearch}>
                  <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                    <input
                      type="text"
                      className="grow outline-none rounded-md px-1 dark:bg-slate-900 dark:text-white w-32 lg:w-40"
                      placeholder="Search"
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                    />
              ...
              {/* Wishlist Icon */}
              <Link to="/wishlist" className="btn btn-ghost btn-circle btn-sm">
                <div className="indicator">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5"
                  ...
                  {wishlistItems.length > 0 && (
                    <span className="badge badge-xs indicator-item bg-pink-500 text-white border-none">
                      {wishlistItems.length}
                    </span>
                  )}
                </div>
